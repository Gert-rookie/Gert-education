package top.fotg.vod.controller;
...
import top.fotg.vod.Utils.ConstantVodUtils;
import top.fotg.vod.Utils.InitVodCilent;
import top.fotg.vod.service.VodService;
...
public class VodController {
    ...
    public R removeAlyVideo(@PathVariable String id) {
        try {
            ...
            e.printStackTrace();
            throw new GertException(20001,"删除视频失败");
        }
    }
    ...
    public R getPlayAuth(@PathVariable String id) {
        try {
            ...
            throw new GertException(20001,"获取凭证失败");
        }
    }
}
